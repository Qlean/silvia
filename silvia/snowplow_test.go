...
var transformResultsSnowplow = []struct {
...
}{
	{
		...
		map[string]interface{}{
			...
			"DvceTstamp":       func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-03-30T18:46:20+03:00"); return t }(),
			...
			"GeoRegion":        sql.NullString{Valid: false},
			"GeoCity":          sql.NullString{Valid: false},
			"GeoZipcode":       sql.NullString{Valid: false},
			"GeoLatitude":      float32(55.750000),
			"GeoLongtitude":    float32(37.616600),
			"GeoRegionName":    sql.NullString{Valid: false},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Aid":              sql.NullString{`qlean_web_app`, true},
			"Platform":         sql.NullString{`web`, true},
			"DvceTstamp":       func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T20:47:06+03:00"); return t }(),
			"Event":            sql.NullString{`pv`, true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Aid":              sql.NullString{`qlean_web_app`, true},
			"Platform":         sql.NullString{`web`, true},
			"DvceTstamp":       func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T20:47:17+03:00"); return t }(),
			"Event":            sql.NullString{`pv`, true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Aid":              sql.NullString{`qlean_web_app`, true},
			"Platform":         sql.NullString{`web`, true},
			"DvceTstamp":       func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T20:47:11+03:00"); return t }(),
			"Event":            sql.NullString{`pv`, true},
			...
			"GeoCity":          sql.NullString{Valid: false},
			"GeoZipcode":       sql.NullString{Valid: false},
			"GeoLatitude":      float32(59.950001),
			"GeoLongtitude":    float32(10.750000),
			"GeoRegionName":    sql.NullString{Valid: false},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Aid":              sql.NullString{`qlean_web_app`, true},
			"Platform":         sql.NullString{`web`, true},
			"DvceTstamp":       func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T20:47:07+03:00"); return t }(),
			"Event":            sql.NullString{`pv`, true},
			...
			"SessionID":        sql.NullString{Valid: false},
			"GeoCountry":       sql.NullString{`Russian Federation`, true},
			"GeoRegion":        sql.NullString{`48`, true},
			"GeoCity":          sql.NullString{`Moscow`, true},
			"GeoZipcode":       sql.NullString{`101976`, true},
			"GeoLatitude":      float32(55.752201),
			"GeoLongtitude":    float32(37.615601),
			"GeoRegionName":    sql.NullString{`48`, true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Aid":              sql.NullString{`qlean_web_app`, true},
			"Platform":         sql.NullString{`web`, true},
			"DvceTstamp":       func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T20:48:06+03:00"); return t }(),
			"Event":            sql.NullString{`pv`, true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Aid":              sql.NullString{`qlean_web_app`, true},
			"Platform":         sql.NullString{`web`, true},
			"DvceTstamp":       func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T20:47:18+03:00"); return t }(),
			"Event":            sql.NullString{`pv`, true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"DvceTstamp":       func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T20:47:16+03:00"); return t }(),
	...
	},
	{
		...
		map[string]interface{}{
			...
			"SessionID":        sql.NullString{Valid: false},
			"GeoCountry":       sql.NullString{`Russian Federation`, true},
			"GeoRegion":        sql.NullString{`66`, true},
			"GeoCity":          sql.NullString{`Saint Petersburg`, true},
			"GeoZipcode":       sql.NullString{`196233`, true},
			"GeoLatitude":      float32(59.751301),
			"GeoLongtitude":    float32(30.476601),
			"GeoRegionName":    sql.NullString{`66`, true},
			"PageURL":          sql.NullString{Valid: false},
			"PageTtile":        sql.NullString{Valid: false},
			"PageReferrer":     sql.NullString{Valid: false},
			"PageURLHost":      sql.NullString{Valid: false},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Aid":              sql.NullString{`qlean_web_app`, true},
			"Platform":         sql.NullString{`web`, true},
			"DvceTstamp":       func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T20:47:53+03:00"); return t }(),
			"Event":            sql.NullString{`pv`, true},
