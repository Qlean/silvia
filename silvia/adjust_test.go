...
var transformResults = []struct {
...
}{
	{
		...
		map[string]interface{}{
			...
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-01-11T23:02:09Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:46:55Z"); return t }(), true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:42Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:42Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-01-11T23:02:09Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:47Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-01-11T23:02:09Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:49Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2015-11-25T12:43:03Z"); return t }(), true},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2015-11-25T17:55:26Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:50Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-01-11T23:02:09Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:51Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-01-11T23:02:09Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:55Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:42Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:58Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-01-11T23:02:09Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:59Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:42Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:48:05Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:42Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:48:57Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:42Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:48:45Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-01-11T23:02:09Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:48:34Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-01-11T23:02:09Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:48:33Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:42Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:48:27Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:42Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:48:18Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:42Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:48:17Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	},
	{
		...
		map[string]interface{}{
			...
			"Clt":        NullTime{Valid: false},
			"It":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:47:42Z"); return t }(), true},
			"Ct":         NullTime{func() time.Time { t, _ := time.Parse(time.RFC3339, "2016-04-15T17:48:15Z"); return t }(), true},
			"Rt":         NullTime{Valid: false},
			"Reg":        sql.NullString{"zz", true},
			"C":          sql.NullString{"ru", true},
			"Lng":        sql.NullString{"ru", true},
	...
	for _, testCase := range transformResults {
		...
		for fieldName, expectedValue := range testCase.expected {
			...
			if fieldValue != expectedValue {
				// testt, _ := time.Parse(time.RFC3339, "2016-04-15T17:48:15Z")
				// t.Errorf("Testt %s\n", testt)
